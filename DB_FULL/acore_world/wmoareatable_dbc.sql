...
-- Dumping data for table acore_world.wmoareatable_dbc: 1 rows
DELETE FROM `wmoareatable_dbc`;
/*!40000 ALTER TABLE `wmoareatable_dbc` DISABLE KEYS */;
INSERT INTO `wmoareatable_dbc` (`ID`, `WMOID`, `NameSetID`, `WMOGroupID`, `SoundProviderPref`, `SoundProviderPrefUnderwater`, `AmbienceID`, `ZoneMusic`, `IntroSound`, `Flags`, `AreaTableID`, `AreaName_Lang_enUS`, `AreaName_Lang_enGB`, `AreaName_Lang_koKR`, `AreaName_Lang_frFR`, `AreaName_Lang_deDE`, `AreaName_Lang_enCN`, `AreaName_Lang_zhCN`, `AreaName_Lang_enTW`, `AreaName_Lang_zhTW`, `AreaName_Lang_esES`, `AreaName_Lang_esMX`, `AreaName_Lang_ruRU`, `AreaName_Lang_ptPT`, `AreaName_Lang_ptBR`, `AreaName_Lang_itIT`, `AreaName_Lang_Unk`, `AreaName_Lang_Mask`) VALUES
	(70359, 9625, 0, -1, 0, 0, 0, 0, 0, 0, 4990, 'Blackwing Descent', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 16712172);
