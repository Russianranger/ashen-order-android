...
-- Dumping data for table acore_world.vehicle_template_accessory: 195 rows
...
INSERT INTO `vehicle_template_accessory` (`entry`, `accessory_entry`, `seat_id`, `minion`, `description`, `summontype`, `summontimer`) VALUES
	...
	(720000, 9858, 1, 1, 'Traveler Mammoth (A) - Vendor', 6, 30000),
	(720000, 400161, 2, 1, 'Traveler Mammoth (A) - Vendor & Repairer', 6, 30000);
