...
INSERT INTO `battleground_template` (`ID`, `MinPlayersPerTeam`, `MaxPlayersPerTeam`, `MinLvl`, `MaxLvl`, `AllianceStartLoc`, `AllianceStartO`, `HordeStartLoc`, `HordeStartO`, `StartMaxDist`, `Weight`, `ScriptName`, `Comment`) VALUES
	...
	(2, 5, 15, 10, 80, 769, 3.14159, 770, 0.151581, 75, 1, '', 'Warsong Gulch (battleground)'),
	(3, 8, 20, 10, 80, 890, 3.91571, 889, 0.813671, 75, 1, '', 'Arathi Basin (battleground)'),
	...
	(7, 8, 15, 60, 80, 1103, 3.03123, 1104, 0.055761, 10, 1, '', 'Eye of The Storm (battleground)'),
	...
	(32, 10, 10, 10, 80, 0, 0, 0, 0, 0, 1, '', 'Random Battleground (battleground)');
