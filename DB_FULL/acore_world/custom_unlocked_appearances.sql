...
-- Dumping structure for table acore_world.custom_unlocked_appearances
...
-- Dumping data for table acore_world.custom_unlocked_appearances: ~0 rows (approximately)
