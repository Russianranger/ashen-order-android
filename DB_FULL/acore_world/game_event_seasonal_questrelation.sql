...
-- Dumping structure for table acore_world.game_event_seasonal_questrelation
...
-- Dumping data for table acore_world.game_event_seasonal_questrelation: 691 rows
