...
-- Dumping data for table acore_world.spell_linked_spell: 658 rows
...
INSERT INTO `spell_linked_spell` (`spell_trigger`, `spell_effect`, `type`, `comment`) VALUES
	...
	(28282, 100229, 2, 'Assbringer'),
	(100257, 100260, 0, 'Fel Infusion'),
	(1190001, 1190002, 0, 'Frost Latch'),
	(1190004, 1190006, 0, 'Fleshy Explosion'),
	(1190001, 200160, 0, 'Frost Latch'),
	(1190009, 1190012, 0, 'Gorefiend Damage'),
	(1190013, 1190014, 2, 'Dark Guardian'),
	(-1190013, -1190014, 0, 'Dark Guardian'),
	(900067, 980068, 0, 'Rampage'),
	(900067, 14204, 0, 'Rampage'),
	(59754, 80027, 0, 'Glyph of Rune Tap'),
	(768, 885419, 2, 'Cat Form'),
	(48409, 848409, 2, 'Feral Swipe'),
	(48410, 848410, 2, 'Feral Swipe'),
	(100234, 34999, 0, 'Entropic Embrace'),
	(1719, 856354, 0, 'Recklessness speed'),
	(60103, 42889, 0, 'Lava Lash Attack'),
	(828730, 22848, 0, 'Shield Mastery'),
	(890013, 890014, 2, 'Rockbiter'),
	(-890013, -890014, 0, 'Rockbiter'),
	(844425, 849705, 0, 'Arcane Surge'),
	(-49152, -100265, 0, 'SMF'),
	(832182, 65633, 0, 'Time Warp Visual 1'),
	(812727, 890015, 2, 'Shield Mastery - Stam'),
	(100210, -100225, 0, 'Skyburst'),
	(100218, -100225, 0, 'Skyburst'),
	(100220, -100225, 0, 'Skyburst'),
	(844425, 844426, 0, 'Arcane Surge'),
	(80025, 825046, 0, 'Arcane Torrent'),
	(80025, 828731, 0, 'Arcane Torrent'),
	(80025, 850613, 0, 'Arcane Torrent'),
	(861614, 861618, 0, 'Land Mine Barrier'),
	(-881728, -881729, 0, 'Unified Might'),
	(881728, 881729, 2, 'Unified Might'),
	(891243, 891245, 0, 'Engorged'),
	(13241, 844053, 0, 'Sapper Charge Dummy'),
	(2379, 129996, 0, 'Swiftness Potion'),
	(88774, 88775, 0, 'Symbiosis Unlearn Spell Links'),
	(88774, 88776, 0, 'Symbiosis Unlearn Spell Links'),
	(88774, 88777, 0, 'Symbiosis Unlearn Spell Links'),
	(88774, 88778, 0, 'Symbiosis Unlearn Spell Links'),
	(88774, 88779, 0, 'Symbiosis Unlearn Spell Links'),
	(1190009, 1192009, 0, 'Gorefiend AttackMe'),
	(-42201, 42205, 0, 'Eternal Silence trigger Residue of Eternity on removal'),
	(82381, 858823, 0, 'Prismatic Guard'),
	(850253, 858824, 0, 'Martyr'),
	(-45964, -46333, 0, ''),
	(45964, 46333, 0, ''),
	(781, 882983, 0, 'Disengage - Posthaste'),
	(855058, 866233, 0, 'Unbreakable Will Debuff'),
	(920168, 879392, 2, 'Guardian of Ancient Kings'),
	(-920168, -879392, 0, 'Guardian of Ancient Kings'),
	(33151, 833151, 2, 'Surge of Light'),
	(-33151, -833151, 0, 'Surge of Light'),
	(190030, -15473, 0, 'Seraphic - Shadowform'),
	(883026, 883027, 0, 'Warrior Tier'),
	(883026, 866234, 0, 'Warrior Tier'),
	(15473, -828701, 1, 'Shadowform - Haste spell from t2.5'),
	(15473, -10060, 1, 'Priest shadowform and PI'),
	...
	(800014, 810014, 2, 'Astral Connection'),
	(-800014, -810014, 0, 'Astral Connection'),
	(-863304, -47241, 0, 'Meta'),
	(-863303, -47241, 0, 'Meta');
