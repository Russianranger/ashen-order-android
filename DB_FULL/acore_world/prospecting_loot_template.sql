...
-- Dumping data for table acore_world.prospecting_loot_template: 41 rows
...
INSERT INTO `prospecting_loot_template` (`Entry`, `Item`, `Reference`, `Chance`, `QuestRequired`, `LootMode`, `GroupId`, `MinCount`, `MaxCount`, `Comment`) VALUES
	...
	(10620, 7910, 0, 20, 0, 1, 1, 1, 2, 'Star Ruby'),
	(22202, 20848, 0, 0, 0, 1, 1, 1, 5, ''),
	(22202, 834055, 0, 0, 0, 1, 1, 1, 1, ''),
	(22203, 834055, 0, 100, 0, 1, 0, 1, 2, ''),
	(22203, 834056, 0, 1, 0, 1, 1, 1, 1, '');
