...
-- Dumping data for table acore_world.dungeon_access_requirements: 44 rows
...
INSERT INTO `dungeon_access_requirements` (`dungeon_access_id`, `requirement_type`, `requirement_id`, `requirement_note`, `faction`, `priority`, `leader_only`, `comment`) VALUES
	...
	(62, 1, 10277, 'You must complete the quest "The Caverns of Time" to enter Old Hillsbrad.', 2, NULL, 0, NULL),
	(123, 2, 16309, 'You must have the Drakefire Amulet in your inventory before entering Onyxia\'s Lair.', 2, NULL, 0, ''),
	(47, 1, 10888, 'You must complete "The Trial of the Naaru: Magtheridon" to enter The Eye.', 2, NULL, 0, NULL),
	(32, 1, 10445, 'You must complete the quest "The Vials of Eternity" and be level 70 before entering The Battle of Mount Hyjal.', 2, NULL, 0, NULL),
	(63, 1, 10277, 'You must complete the quest "The Caverns of Time" to enter Old Hillsbrad.', 2, NULL, 0, NULL),
	(16, 2, 16309, NULL, 2, NULL, 0, NULL),
	(47, 2, 31704, 'You must possess The Tempest Key to enter The Eye.', 2, NULL, 0, NULL),
	(15, 2, 16309, NULL, 2, NULL, 0, NULL),
	(46, 1, 10901, 'You must complete the quest "The Cudgel of Kar\'desh" and be level 70 before entering Serpentshrine Reservoir.', 2, NULL, 0, NULL),
	(20, 1, 8182, 'You must complete the quest "The Hand of Rastakhan" and be level 60 before entering Zul\'Gurub.', 2, NULL, 0, NULL),
	(64, 1, 10985, 'You must complete the quest "A Distraction for Akama" before entering The Black Temple.', 2, NULL, 0, NULL),
