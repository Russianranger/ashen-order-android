...
-- Dumping data for table acore_world.disenchant_loot_template: 125 rows
...
INSERT INTO `disenchant_loot_template` (`Entry`, `Item`, `Reference`, `Chance`, `QuestRequired`, `LootMode`, `GroupId`, `MinCount`, `MaxCount`, `Comment`) VALUES
	...
	(51, 20725, 0, 0.5, 0, 1, 1, 1, 1, 'Nexus Crystal'),
	(51, 22448, 0, 99.5, 0, 1, 1, 1, 1, 'Small Prismatic Shard'),
	(52, 22449, 0, 99.5, 0, 1, 1, 1, 1, 'Large Prismatic Shard'),
	(52, 22450, 0, 0.5, 0, 1, 1, 1, 1, 'Void Crystal'),
	(53, 34053, 0, 99.5, 0, 1, 1, 1, 1, 'Small Dream Shard'),
	(53, 34057, 0, 0.5, 0, 1, 1, 1, 1, 'Abyss Crystal'),
	(54, 34057, 0, 0.5, 0, 1, 1, 1, 2, 'Abyss Crystal'),
	(54, 34052, 0, 99.5, 0, 1, 1, 1, 2, 'Dream Shard'),
	...
	(40, 10978, 0, 100, 0, 1, 0, 1, 1, 'Small Glimmering Shard');
