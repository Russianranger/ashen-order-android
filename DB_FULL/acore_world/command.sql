...
-- Dumping data for table acore_world.command: 622 rows
DELETE FROM `command`;
...
INSERT INTO `command` (`name`, `security`, `help`) VALUES
	...
	('sb', 3, 'Syntax: .sb - type .sb to list subcommands.'),
	('sb additem', 3, 'Syntax: .sb additem <itemid> <count> - tries to add an enchanted item to targeted player.'),
	...
	('individualProgression set', 0, 'Syntax: .individualProgression set $player $progressionLevel\nSets the player to the given progression level.'),
