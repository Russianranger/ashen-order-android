...
-- Dumping structure for table acore_characters.zone_difficulty_encounter_logs
DROP TABLE IF EXISTS `zone_difficulty_encounter_logs`;
...
-- Dumping data for table acore_characters.zone_difficulty_encounter_logs: ~0 rows (approximately)
DELETE FROM `zone_difficulty_encounter_logs`;
