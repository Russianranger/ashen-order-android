...
-- Dumping data for table acore_characters.guild: ~2 rows (approximately)
DELETE FROM `guild`;
INSERT INTO `guild` (`guildid`, `name`, `leaderguid`, `EmblemStyle`, `EmblemColor`, `BorderStyle`, `BorderColor`, `BackgroundColor`, `info`, `motd`, `createdate`, `BankMoney`) VALUES
	(1, 'The Ashen Order', 41, 0, 0, 0, 0, 0, '', 'No message set.', 1714246082, 498048),
	(2, 'Blub', 171, 0, 0, 0, 0, 0, '', 'No message set.', 1737626660, 778455);
