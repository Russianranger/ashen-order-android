...
-- Dumping structure for table acore_characters.characters_npcbot_gear_set
DROP TABLE IF EXISTS `characters_npcbot_gear_set`;
CREATE TABLE IF NOT EXISTS `characters_npcbot_gear_set` (
...
-- Dumping data for table acore_characters.characters_npcbot_gear_set: ~0 rows (approximately)
DELETE FROM `characters_npcbot_gear_set`;
