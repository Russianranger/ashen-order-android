...
//Vectors
const static std::vector<uint32> HARDCORE_SPELLS = { 100117, 100118, 100105 };
...
const static std::unordered_map<std::string_view, uint32> HARDCORE_ITEMS = {
    ...
    {"ITEM_90000", 90000}, 
    {"REST_REMOVER", 800048}, // Slow and Steady
};
...
public:
    ...
    bool OnGossipSelect(Player* player, Creature* creature, uint32 sender, uint32 action) override
    {
        ...
        {
        case 1:
            AddGossipItemFor(player, 0, "This challenge will heavily penalize you for any form of death. Additionally it will remove all your current gold and remove bonus starter items! This challenge mode offers various rewards at certain milestones.", 0, 2);
        ...
        case 14:
            AddGossipItemFor(player, 0, "Ironman Mode is for those seeking a true challenge. In this mode, you can only equip common or poor quality items. Brace yourself for a test of skill and perseverance. Are you up to the task?  This challenge mode offers various rewards at certain milestones.", 0, 15);
            AddGossipItemFor(player, 0, "NO TAKE ME BACK!", 0, 3);
            SendGossipMenuFor(player, 1, creature->GetGUID());
            break;
        case 15:
        ...
        case 18:
            ...
            break;
        case 19:
            AddGossipItemFor(player, 0, "In Randomly Attacked Mode, you will be randomly attacked by enemies along your journey. Be vigilant and stay on your guard! Are you ready for the challenge? This challenge mode offers various rewards at certain milestones.", 0, 20);
            AddGossipItemFor(player, 0, "NO TAKE ME BACK!", 0, 3);
            SendGossipMenuFor(player, 1, creature->GetGUID());
            break;
        case 20:
            player->AddItem(800050, 1);
            ChatHandler(player->GetSession()).PSendSysMessage("You have embraced the Randomly Attacked Mode. Be vigilant and stay on your guard as enemies may attack you at any moment! This challenge mode offers various rewards at certain milestones.");
            CloseGossipMenuFor(player);
            break;
        case 21:
            ...
            break;
        case 22:
            AddGossipItemFor(player, 0, "Pacifist Mode calls to those who wish to traverse the vast expanses of Azeroth, not as conquerors, but as harmonious explorers. Embrace this path, and no creature shall fall by your hand. Are you prepared to embody tranquility and tread a path of peace?  This challenge mode offers various rewards at certain milestones.", 0, 24);
            AddGossipItemFor(player, 0, "NO TAKE ME BACK!", 0, 3);
            SendGossipMenuFor(player, 1, creature->GetGUID());
            break;
        case 23:
        ...
        case 24:
            ...
            ChatHandler(player->GetSession()).PSendSysMessage("You have embraced the Pacifist Mode. In this mode, you will not be able to kill any creature. Failing the challenge will leave you with a 7 day debuff. Joining a group in this mode will fail your challenge.  This challenge mode offers various rewards at certain milestones.");
            CloseGossipMenuFor(player);
            break;
        case 25:
            AddGossipItemFor(player, 0, "Embrace the Diet Mode, perfect for those looking to shed some pixels. Eating and drinking? Overrated! Prepare for an adventure that's as lean as it gets. Ready to experience the 'hangry' side of Azeroth?  This challenge mode offers various rewards at certain milestones.", 0, 29);
            AddGossipItemFor(player, 0, "NO TAKE ME BACK!", 0, 3);
            SendGossipMenuFor(player, 1, creature->GetGUID());
            break;
        case 26:
        ...
        case 29:
            ...
            break;
        case 30:
            AddGossipItemFor(player, 0, "Think you're brave? Try Taxation Without Representation Mode! With a 75% gold tax, your wealth will disappear faster than a murloc's dignity at a fish market!  This challenge mode offers various rewards at certain milestones. Note: Being in a guild with guild funds module active will make earnings 90% of whatever you earned for guild funds. Highy reccomended to not do this challenge while in a guild, unless you want to be extra hardcore.", 0, 34);
