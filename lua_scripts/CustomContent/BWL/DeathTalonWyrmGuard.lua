...
function DeathTalonWyrmGuard.CastAbility1(eventId, delay, calls, creature)
    creature:CastSpell(creature:GetVictim(), DeathTalonWyrmGuard.SPELL_IDS.ABILITY_1, true)
end

function DeathTalonWyrmGuard.CastAbility2(eventId, delay, calls, creature)
    creature:CastSpell(creature:GetVictim(), DeathTalonWyrmGuard.SPELL_IDS.ABILITY_2, true)
end
...
function DeathTalonWyrmGuard.OnEnterCombat(event, creature, target)
    ...
    creature:RegisterEvent(DeathTalonWyrmGuard.CastAbility2, math.random(22000, 27000), 0)
end
