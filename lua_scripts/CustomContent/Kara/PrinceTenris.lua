...
function PrinceTenrisMirkblood.OnEnterCombat(event, creature, target)
    ...
    creature:RegisterEvent(PrinceTenrisMirkblood.CastSanguineSpirit, math.random(14000, 20000), 0)
    creature:RegisterEvent(PrinceTenrisMirkblood.CastSanguineStrike, math.random(13000, 21000), 0)
