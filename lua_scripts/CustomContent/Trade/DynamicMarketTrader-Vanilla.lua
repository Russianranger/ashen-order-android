...
local SCRIPT_ENABLED = false  -- Set to false to disable the script
...
local ORIGINAL_TIMESTAMP = 1699474278 -- Time in unix, currently set to Sat Jun 27 2023. You'll want to set the time in unix for when your server started https://www.unixtimestamp.com/ Inflation will be calculated based on the time difference from this point.
...
local categories = {
  { name = "|TInterface\\Icons\\inv_misc_herb_frostlotus:40:40:-42|t|cFFFFFFFFHerbs|r", intid = 100, items = {
	...
	{ name = "|TInterface\\Icons\\inv_inscription_pigment_grey:40:40:-42|t|cFFFFFFFFPigments|r", intid = 900, items = { -- I Highly Suggest you decrease vendor buy prices of Pigments and Inks
        ...
        { name = "|TInterface\\Icons\\inv_inscription_pigment_verdant:36:36:-42|tVerdant Pigment", id = 43103, price = 125 },
		...
		{ name = "|TInterface\\Icons\\inv_inscription_pigment_sapphire:36:36:-42|tSapphire Pigment", id = 43107, price = 789 },
    }},
	{ name = "|TInterface\\Icons\\inv_inscription_inkgreen02:40:40:-42|t|cFFFFFFFFInk|r", intid = 800, items = {
    ...
    { name = "|TInterface\\Icons\\inv_misc_leatherscrap_07:40:40:-42|t|cFFFFFFFFSkinning - Basic|r", intid = 300, items = {
	...
	{ name = "|TInterface\\Icons\\inv_misc_leatherscrap_11:40:40:-42|t|cFFFFFFFFSkinning - Advanced|r", intid = 400, items = {
		...
		{ name = "|TInterface\\Icons\\inv_misc_pelt_bear_03:36:36:-42|tCured Rugged Hide", id = 15407, price = 140000 },
    ...
    { name = "|TInterface\\Icons\\inv_misc_food_119_RhinoMeat:40:40:-42|t|cFFFFFFFFCooking Ingredients - Meat|r", intid = 500, items = {
    ...
    { name = "|TInterface\\Icons\\inv_misc_fish_51:40:40:-42|t|cFFFFFFFFCooking Ingredients - Seafood|r", intid = 600, items = {
    ...
    { name = "|TInterface\\Icons\\inv_enchant_dustillusion:40:40:-42|t|cFFFFFFFFEnchanting|r", intid = 700, items = {
    ...
    { name = "|TInterface\\Icons\\inv_rod_adamantite:40:40:-42|t|cFFFFFFFFRods|r", intid = 1400, items = {
    ...
    { name = "|TInterface\\Icons\\inv_ore_tin_01:40:40:-42|t|cFFFFFFFFOre|r", intid = 1000, items = {
   ...
   { name = "|TInterface\\Icons\\inv_ingot_07:40:40:-42|t|cFFFFFFFFIngots|r", intid = 1100, items = {
    ...
    { name = "|TInterface\\Icons\\inv_misc_gem_ruby_02:40:40:-42|t|cFFFFFFFFGems|r", intid = 1200, items = {
        ...
        { name = "|TInterface\\Icons\\inv_misc_gem_opal_01:36:36:-42|tLarge Opal", id = 12799, price = 19500 },
	...
	{ name = "|TInterface\\Icons\\inv_elemental_primal_shadow:40:40:-42|t|cFFFFFFFFEssences & Elementals|r", intid = 1500, items = {
    ...
    { name = "|TInterface\\Icons\\trade_engineering:40:40:-42|t|cFFFFFFFFParts|r", intid = 1300, items = {
		...
		{ name = "|TInterface\\Icons\\inv_battery_02:36:36:-42|tGold Power Core", id = 10558, price = 1498 },
    ...
    { name = "|TInterface\\Icons\\inv_stone_10:40:40:-42|t|cFFFFFFFFStones and Misc|r", intid = 1600, items = {
...
local function OnGossipHelloVanillaTrader(event, player, object)
    if not SCRIPT_ENABLED then
        local message = "This script is currently disabled. It can be reenabled in lua_scripts\\CustomContent\\Trade\\DynamicMarketTrader"
...
local function OnSpawnVanillaTrader(event, creature)
    if not SCRIPT_ENABLED then
...
for _, NPCID in ipairs(NPCIDs) do
    ...
    RegisterCreatureEvent(NPCID, 5, OnSpawnVanillaTrader)
end