local DruidBearMorphs = {
    [109] = {displayId = 600016, name = "Avatar of Ursol Sapphire"},
    [110] = {displayId = 600017, name = "Avatar of Ursol Emerald"},
    [111] = {displayId = 600018, name = "Avatar of Ursol Amethyst"},
    [112] = {displayId = 600019, name = "Avatar of Ursol Ruby"}
}
...
local function CreateDruidBearGossipMenu(player)
    ...
    player:GossipSendMenu(100, player, 865011)  
end

local function OnDruidBearItemUse(event, player, item, target)
    if item:GetEntry() == 865011 then 
...
RegisterItemEvent(865011, 2, OnDruidBearItemUse)  
RegisterPlayerGossipEvent(865011, 2, OnDruidBearGossipSelect)  