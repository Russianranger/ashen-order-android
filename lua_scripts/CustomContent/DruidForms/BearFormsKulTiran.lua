local DruidBearMorphs = {
    [125] = {displayId = 600032, name = "Bear Kul Tiran Coral"},
    [126] = {displayId = 600033, name = "Bear Kul Tiran Onyx"},
    [127] = {displayId = 600034, name = "Bear Kul Tiran Emerald"},
    [128] = {displayId = 600035, name = "Bear Kul Tiran Citrine"}
}
...
local function CreateDruidBearGossipMenu(player)
    ...
    player:GossipSendMenu(100, player, 865015)  
end

local function OnDruidBearItemUse(event, player, item, target)
    if item:GetEntry() == 865015 then 
...
RegisterItemEvent(865015, 2, OnDruidBearItemUse)  
RegisterPlayerGossipEvent(865015, 2, OnDruidBearGossipSelect)  