...
local DruidFlightMorphs = {
    [306] = {displayId = 600121, name = "Ardenweald moth Sapphire"},
    [307] = {displayId = 600122, name = "Ardenweald moth Onyx"},
    [308] = {displayId = 600123, name = "Ardenweald moth Emerald"},
    [309] = {displayId = 600124, name = "Ardenweald moth Ruby"}
}
...
local function CreateDruidFlightGossipMenu(player)
    ...
    player:GossipSendMenu(100, player, 865027)  
end

local function OnDruidFlightItemUse(event, player, item, target)
    if item:GetEntry() == 865027 then  
...
RegisterItemEvent(865027, 2, OnDruidFlightItemUse) 
RegisterPlayerGossipEvent(865027, 2, OnDruidFlightGossipSelect) 
